  ...
  return (
    <div className='m-0 p-0 bg-blue-950 text-white'>
      <div className='  container max-w-screen-md m-auto'>
        ...
        <h1>Collection of Personal Information</h1>
        <p>We collect personal information from you when you register with us, subscribe to our newsletter, respond to a survey or fill out a form. When registering with us, you provide us with your name, email address, password, and a phone number. You may, however, choose to provide us with other information including address, billing information, or other data that maybe linked directly or indirectly to your account. </p>
        ...
        <p> At Drishti Mechanical Tech Fest, we strive to offer fair and competitive pricing for our events. The registration fees for each of our eight events may vary and will be clearly outlined on our website and registration platform. We are committed to providing a valuable experience for all participants.
        </p>
        <h1> Refund Policy:</h1>

        <p>  Refunds for Event Cancellation: In the event that Drishti Mechanical Tech Fest organizers cancel any of the scheduled events, participants who have registered for the canceled event(s) will receive a full refund of their registration fees.

          Refunds for Non-Attendance: Please note that we do not provide refunds if a registered participant fails to attend any of the events they have registered for. We allocate resources and make arrangements based on the number of registered participants, and thus, the registration fee is non-refundable for no-shows.
        </p>
        <h1> Cancellation Policy:</h1>
        <p>
          Once a participant has registered for any event at the Drishti Mechanical Tech Fest, they are not allowed to unregister or cancel their registration. We maintain a strict no-cancellation policy to ensure effective event planning and execution.

          We understand that unforeseen circumstances can arise, but we encourage participants to carefully consider their availability and commitment before registering for any of our events. By registering, participants acknowledge and agree to abide by this no-cancellation policy.
        ...
        <p> By registering for an event on the Drishti website, you acknowledge that you have read, understood, and accepted our no-refund and no-cancellation policy.
        </p>

        <p> We appreciate your understanding and commitment to making Drishti a successful and memorable experience for all participants.
        </p>
